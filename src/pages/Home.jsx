          ...
          <div className="max-w-3xl mx-auto mb-8 animate-fade-in-up delay-250">
            <div className="inline-flex flex-col gap-2 text-left px-4 py-3 rounded-xl bg-surface/80 dark:bg-zinc-800/70 border border-border dark:border-zinc-700">
              <p className="text-sm md:text-base text-text-muted dark:text-zinc-300">
                ...
                , currently pursuing a strong foundation in software engineering
              ...
              <p className="text-sm md:text-base text-text-muted dark:text-zinc-300">
                ...
                , where I contribute to building high-quality, scalable, and
                ...
                <div className="bg-surface dark:bg-zinc-800/60 rounded-2xl border border-border dark:border-zinc-700 p-5 transition-all hover:border-accent/30 hover:shadow-lg hover:shadow-accent/5">
                  <div className="flex items-center gap-5">
                    ...
                    {exp.logo ? (
                      ...
                      <div className="shrink-0 w-18 h-18 rounded-xl bg-linear-to-br from-accent/20 to-accent/5 border border-accent/20 flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {exp.companyUrl ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-block text-base text-text-muted dark:text-zinc-300 font-semibold mt-0.5 hover:text-accent hover:underline"
                        >
                          {exp.company}
                        </a>
                      ) : (
